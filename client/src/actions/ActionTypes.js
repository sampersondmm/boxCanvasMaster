const ActionTypes = {
    ...
    CHANGE_SHAPE_STROKE_WIDTH: 'CHANGE_SHAPE_STROKE_WIDTH',
    UPDATE_LINE: 'UPDATE_LINE',
    UPDATE_SELECTED_SHAPE: 'UPDATE_SELECTED_SHAPE',
    SELECT_POINT: 'SELECT_POINT',
    TOGGLE_CANVAS_ACTION: 'TOGGLE_CANVAS_ACTION',

    //Canvas DB
    SET_CANVAS_DATA: 'SET_CANVAS_DATA',
    LOAD_CANVAS_LIST: 'LOAD_CANVAS_LIST',
    REMOVE_MESSAGE: 'REMOVE_MESSAGE',
    UPDATE_CANVAS_TITLE: 'UPDATE_CANVAS_TITLE',
    UPDATE_CANVAS_DESCRIPTION: 'UPDATE_CANVAS_DESCRIPTION',
